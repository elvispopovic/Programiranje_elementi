...
void displayBestTour()
{
    ...
    car** pptCar;
    pass** pptPass;
    if(bestCostTour.arcs->a == nullptr)
        return;
    cout << "Best: iteration: " << bestCostTour.iteration << ", ant: " << bestCostTour.ant;
    cout << ", start node: " << nodes[bestCostTour.arcs->a->row].name;
    ...
    calculateCostsFromTour(&bestCostTour, wcost, ccost);
    cout << "========================= (eoi)" << endl;
}