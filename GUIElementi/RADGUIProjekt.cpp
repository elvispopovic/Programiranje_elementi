...
public:
	...
	{
		//nije do kraja razjasnjeno zašto se dll sruši ako se posljednji form releasa
        //zato release prethodi i briše trenutni form i otvara novi. Posljednji se ne releasa
		if(form!=NULL)
		{
			form->Release();
			form = new TForm1(NULL,TestObjekt);
