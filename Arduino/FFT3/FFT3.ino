/*
 * OVO JE PRIMJER ZA SERIJSKI PLOTTER
 * DISKRETNE FOURIEROVE TRANSFORMACIJE
 * DISKRETNE SINUSNE I KOSINUSNE TRANSFORMACIJE
 * ULAZ JE OČITAVANJE PINOVA A3 I A4
 */

#include <avr/pgmspace.h>
#define BITOVA 4 //za Uno 4 je maksimalno, za MKR1010 može do 8
...
/* primjer za serial plotter, diskretne sinusne transformacije */
void primjerDST()
{
  word i;
  for(i=0; i<uzoraka; i++)
  ...
  for(i=0; i<uzoraka; i++)
  {
    Serial.print("UlazTestRe:");
    Serial.print(10*ulazTestRe[i],5); Serial.print(" ");
    Serial.print("IzlazTestRe:");
    Serial.println(izlazTestRe[i],5);
    delay(1);
  }
}

/* primjer za serial plotter, diskretne kosinusne transformacije */
void primjerDCT()
{
  word i;
  for(i=0; i<uzoraka; i++)
...
/* primjer za serial plotter, diskretne Fourierove transformacije */
void primjerDFT()
{
  word i;
  ...
  for(i=0; i<uzoraka; i++)
  {
    Serial.print("UlazTestRe:");
    Serial.print(10*ulazTestRe[i],5); Serial.print(" ");
    Serial.print("UlazTestIm:");
    Serial.print(10*ulazTestIm[i],5); Serial.print(" ");
    Serial.print("IzlazTestRe:");
    Serial.print(izlazTestRe[i],5); Serial.print(" ");
    Serial.print("IzlazTestIm:");
    Serial.println(izlazTestIm[i],5);
